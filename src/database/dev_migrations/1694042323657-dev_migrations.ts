...
export class DevMigrations1694042323657 implements MigrationInterface {
    name = 'DevMigrations1694042323657'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Transactions" ("id" SERIAL NOT NULL, "amount" character varying NOT NULL, "status" "public"."Transactions_status_enum" NOT NULL DEFAULT 'Pending', "wallet_balance_before" character varying NOT NULL, "wallet_balance_after" character varying, "created_date" TIMESTAMP NOT NULL, "expireTime" TIMESTAMP NOT NULL, "walletId" integer, "userId" integer, "currencyId" integer, CONSTRAINT "PK_7761bf9766670b894ff2fdb3700" PRIMARY KEY ("id"))`);
