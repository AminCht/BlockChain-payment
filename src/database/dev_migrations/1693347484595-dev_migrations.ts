...
export class DevMigrations1693347484595 implements MigrationInterface {
    name = 'DevMigrations1693347484595'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "Withdraws" ("id" SERIAL NOT NULL, "status" character varying NOT NULL DEFAULT 'Pending', "amount" character varying NOT NULL, "token" character varying NOT NULL, "network" character varying NOT NULL, "dst_wallet" character varying NOT NULL, "tx_hash" character varying, "tx_url" character varying, "created_At" TIMESTAMP NOT NULL, "updated_At" TIMESTAMP NOT NULL, "userId" integer, CONSTRAINT "PK_5e338a7a32dc560edbe9944ba5f" PRIMARY KEY ("id"))`);
