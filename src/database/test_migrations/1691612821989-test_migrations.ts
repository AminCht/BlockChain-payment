...
export class TestMigrations1691612821989 implements MigrationInterface {
    name = 'TestMigrations1691612821989'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Transctions" ("id" SERIAL NOT NULL, "amount" bigint NOT NULL, "network" character varying NOT NULL, "currency" character varying NOT NULL, "status" character varying NOT NULL DEFAULT 'Pending', "wallet_balance_before" bigint NOT NULL, "wallet_balance_after" bigint, "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "expireTime" TIMESTAMP NOT NULL, "walletId" integer, CONSTRAINT "REL_531ef47a3dd72d14cb1ef2a93b" UNIQUE ("walletId"), CONSTRAINT "PK_d1d68b8237d2f3d4d8d68b78959" PRIMARY KEY ("id"))`);
