...
export class TestMigrations1691777396575 implements MigrationInterface {
    name = 'TestMigrations1691777396575'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Transctions" ("id" SERIAL NOT NULL, "amount" character varying NOT NULL, "network" character varying NOT NULL, "currency" character varying NOT NULL, "status" character varying NOT NULL DEFAULT 'Pending', "wallet_balance_before" character varying NOT NULL, "wallet_balance_after" character varying, "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "expireTime" TIMESTAMP NOT NULL, "walletId" integer, CONSTRAINT "PK_d1d68b8237d2f3d4d8d68b78959" PRIMARY KEY ("id"))`);
