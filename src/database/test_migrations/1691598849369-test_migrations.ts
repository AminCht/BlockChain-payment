...
export class TestMigrations1691598849369 implements MigrationInterface {
    name = 'TestMigrations1691598849369'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "Transctions" ("id" SERIAL NOT NULL, "amount" integer NOT NULL, "network" character varying NOT NULL, "currency" character varying NOT NULL, "wallet_balance_before" numeric NOT NULL, "wallet_balance_after" numeric, "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "expireTime" TIMESTAMP NOT NULL, "walletId" integer, CONSTRAINT "REL_531ef47a3dd72d14cb1ef2a93b" UNIQUE ("walletId"), CONSTRAINT "PK_d1d68b8237d2f3d4d8d68b78959" PRIMARY KEY ("id"))`);
